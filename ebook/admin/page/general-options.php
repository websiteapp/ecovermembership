...
<fieldset>
	...
	<legend><?php _e('Branding Options'); ?></legend><br>

	<div class="control-group">
		<label class="control-label" for="site-name"><?php _e('Site name'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('Site name.'); ?>"><i class="icon-question-sign"></i></a></label>
		<div class="controls">
			<input type="text" class="input-xlarge" id="site-name" name="site-name" placeholder="<?php echo 'preferred site/product name'; ?>" value="<?php echo $settings->getOption('site-name'); ?>">
		</div>
	</div>
	
	<div class="control-group">
		<label class="control-label" for="payment-link"><?php _e('Payment link'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('Payment link'); ?>"><i class="icon-question-sign"></i></a></label>
		<div class="controls">
			<input type="url" class="input-xlarge" id="payment-link" name="payment-link" placeholder="<?php echo 'Link to checkout'; ?>" value="<?php echo $settings->getOption('payment-link'); ?>">
		</div>
	</div>
	
	<div class="control-group">
		<label class="control-label" for="support-email"><?php _e('Support email'); ?> <a href="#" data-rel="tooltip" tabindex="99" title="<?php _e('Support email'); ?>"><i class="icon-question-sign"></i></a></label>
		<div class="controls">
			<input type="email" class="input-xlarge" id="support-email" name="support-email" placeholder="<?php echo 'your support email address'; ?>" value="<?php echo $settings->getOption('support-email'); ?>">
		</div>
	</div>
