...
class Generic extends Connect {
	...
	public function denyAccessLogs() {
		...
		return ( ($this->getOption('profile-timestamps-admin-enable') && !in_array(1, $_SESSION['eb']['user_level'])) || !$this->getOption('profile-timestamps-enable') );
	...
	public function generateToken() {
		...
		if(empty($_SESSION['eb']['token']))
			$_SESSION['eb']['token'] = md5(uniqid(mt_rand(),true));
