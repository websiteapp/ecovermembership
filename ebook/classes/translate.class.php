...
class Translate {
	...
	private function setLang() {
		...
		if ( !empty($_GET['lang']) ) :
			...
			if ( $this->displayName($lang) ) :
				$this->lang = $lang;
				$_SESSION['eb']['language'] = $lang;
			endif;

		endif;

		$this->lang = !empty($_SESSION['eb']['language']) ? $_SESSION['eb']['language'] : $this->lang;
	...
	public function languageSelector() {
		...
		foreach ( $options as $code => $language ) {
			...
			$selected = ( !empty($_SESSION['eb']['language']) && $_SESSION['eb']['language'] == $code ) ? 'selected="selected"' : '';
