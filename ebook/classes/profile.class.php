...
class Profile extends Generic {
	...
	function __construct() {
		...
		if(!empty($_SESSION['eb']['forcePwUpdate']))
		...
		// Save the username
		$this->username = !empty($_SESSION['eb']['username']) ? $_SESSION['eb']['username'] : _('Guest');
	...
	private function determineGuest() {
		...
		if ( !empty($_SESSION['eb']['user_id']) && empty($_GET['uid']) )
			$this->user_id = $_SESSION['eb']['user_id'];
		...
		$this->guest = !( !empty($_SESSION['eb']['user_id']) && $_SESSION['eb']['user_id'] == $this->user_id );
	...
	private function updateEmailorPw() {
		...
		if(!empty($_SESSION['eb']['forcePwUpdate'])) unset($_SESSION['eb']['forcePwUpdate']);
